...
# piral-cli-vite5 &middot; [![build](https://github.com/smapiot/piral-cli-vite5/actions/workflows/ci.yml/badge.svg)](https://github.com/smapiot/piral-cli-vite5/actions/workflows/ci.yml) ![GitHub License](https://img.shields.io/badge/license-MIT-blue.svg)

The `piral-cli` plugin for using `vite` (**version 5**) as bundler.
...
- For version 7 of `vite` use [`piral-cli-vite7`](https://github.com/smapiot/piral-cli-vite7).
